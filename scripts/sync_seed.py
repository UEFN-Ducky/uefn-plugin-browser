#!/usr/bin/env python3
"""Copy this package into ducky_app/frontend/uefn_plugins/browser for EXE seeding."""
...
SEED = REPO / "ducky_app" / "frontend" / "uefn_plugins" / "browser"
...
def main() -> None:
    ...
    # Mark as bundled for seed source field.
    import json
